...
-(UIButton *)signOutBtn{
    if (!_signOutBtn) {
        _signOutBtn = [[UIButton alloc] initWithFrame:CGRectMake((kScreenWidth-240)/2.0, kScreenHeight-70, 240,IS_IPAD?50:40)];
        ...
        _signOutBtn.layer.cornerRadius = 20;
