...
- (void)viewDidLoad {
    [super viewDidLoad];
    [[UITabBarItem appearance] setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor colorWithHexString:@"#B4B4B4"],NSFontAttributeName:[UIFont regularFontWithSize:10]} forState:UIControlStateNormal];
    [[UITabBarItem appearance] setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor colorWithHexString:@"#FF7568"],NSFontAttributeName:[UIFont regularFontWithSize:10]} forState:UIControlStateSelected];
...
- (void)initMyTabBar{
    ...
    StudentViewController *teacherVC = [[StudentViewController alloc] init];
    BaseNavigationController * nav2 = [[BaseNavigationController alloc] initWithRootViewController:teacherVC];
    self.teacherItem = [[UITabBarItem alloc] initWithTitle:@"学生" image:[[UIImage imageNamed:@"student_gray"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"student"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    [nav2 setTabBarItem:self.teacherItem];
