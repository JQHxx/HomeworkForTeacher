...
-(void)setMessageModel:(MessageModel *)messageModel{
    ...
    self.timeLab.text = [[ZYHelper sharedZYHelper] timeWithTimeIntervalNumber:messageModel.send_time format:@"yyyy-MM-dd HH:ss"];
    ...
    self.bgView.frame = CGRectMake(self.iconImgView.right+10, self.titleLab.bottom+7, kScreenWidth-self.iconImgView.right-69, contentHeight+(IS_IPAD?40:24));
...
-(UILabel *)titleLab{
    if (!_titleLab) {
        _titleLab = [[UILabel alloc] initWithFrame:CGRectMake(self.iconImgView.right+10, self.timeLab.bottom+17, 120,IS_IPAD?24:12)];
