...
#pragma mark -- POST请求 --
- (void)postWithURLString:(NSString *)URLString parameters:(id)parameters success:(void (^)(id))success failure:(void (^)(NSString *errorStr))failure{
...
-(void)postNotShowLoadingWithURLString:(NSString *)URLString parameters:(id)parameters success:(void (^)(id))success{
    NSString *urlStr = [NSString stringWithFormat:kHostTempURL,URLString];
    MyLog(@"url:%@,params:%@",urlStr,parameters);
    AFHTTPSessionManager *manager = [AFHTTPSessionManager manager];
    manager.responseSerializer = [AFHTTPResponseSerializer serializer];
...
- (void)uploadWithURLString:(NSString *)URLString parameters:(id)parameters uploadParam:(NSArray<UploadParam *> *)uploadParams success:(void (^)(id))success failure:(void (^)(NSString *))failure{
    ...
    NSString *urlStr = [NSString stringWithFormat:kHostTempURL,URLString];
    MyLog(@"uploadWithURLString----url:%@,uploadParams:%@",urlStr,uploadParams);
    AFHTTPSessionManager *manager = [AFHTTPSessionManager manager];
    manager.responseSerializer = [AFHTTPResponseSerializer serializer];
