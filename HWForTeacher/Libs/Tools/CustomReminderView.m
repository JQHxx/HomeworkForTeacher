...
-(instancetype)initWithFrame:(CGRect)frame info:(NSDictionary *)info confirmAction:(ConfirmBlock)confrim{
    ...
    if (self) {
        ...
        self.cancelBtn.frame = CGRectMake(35, self.tipsLab.bottom+25, 96, 32);
        [self.confirmBtn setTitle:info[@"confirm"] forState:UIControlStateNormal];
        self.confirmBtn.frame = CGRectMake(self.cancelBtn.right+24, self.tipsLab.bottom+25, 96, 32);
    }
    return self;
}
...
-(UIButton *)cancelBtn{
    if (!_cancelBtn) {
        _cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(35, self.tipsLab.bottom+25, 96, 32)];
...
-(UIButton *)confirmBtn{
    if (!_confirmBtn) {
        _confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.cancelBtn.right+24, self.tipsLab.bottom+25, 96, 32)];
