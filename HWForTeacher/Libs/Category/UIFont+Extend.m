...
+(UIFont *)regularFontWithSize:(CGFloat)fontSize{
    return [UIFont pingFangSCWithWeight:FontWeightStyleRegular size:IS_IPAD?fontSize+8:fontSize];
}

+(UIFont *)mediumFontWithSize:(CGFloat)fontSize{
    return [UIFont pingFangSCWithWeight:FontWeightStyleMedium size:IS_IPAD?fontSize+8:fontSize];
}
